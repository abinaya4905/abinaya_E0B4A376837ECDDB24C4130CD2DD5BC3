class bank_account:
def
_init_(self,account_number,account_holer_name,initial_balance=0.0):
...
def withdraw(self,amount):
  if amount > 0 and amount < = self.__account_balance:
    ...
    account== Bankaccount(account_number="345777453875",account_holder_name="ABINAYA",initial_balance=500.0)
